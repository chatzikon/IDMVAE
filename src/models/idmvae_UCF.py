...
from .vae_UCF_captions_modality import UCF_Sentence
...
class UCF_Image_Captions(IDMVAE):
    """
    IDMVAE subclass for CUB Image-Captions Experiment
    """
    def __init__(self, vocab_size, params):
        super(UCF_Image_Captions, self).__init__(vocab_size, params, CUB_Image, UCF_Sentence)
